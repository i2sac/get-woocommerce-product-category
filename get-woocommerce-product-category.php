...
Plugin URI: https://github.com/i2sac/get-woocommerce-product-category
Description: A WordPress plugin that returns the main category of a given WooCommerce product via a JS POST request.
Version: 1.0.0
